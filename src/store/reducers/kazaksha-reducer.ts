...
import { datesTranslates } from '../data/dates-data'
...
export const selectTranslates = (category: CategoriesTypes) => (state: RootState) => state.kazaksha.data.translates[category].map((t, i) => ({
    ...t,
    id: i
}))
